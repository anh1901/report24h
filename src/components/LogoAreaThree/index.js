                        ...
                        <div className="nav_style1">
                          ...
                          >
                            <div className="trancarousel_item">
                              <p>
                                <Link to="/">
                                  Giả mạo công an điều tra, gọi điện hù dọa, quy
                                  chụp nhiều tội danh cho người dân
                                </Link>
                              </p>
                            </div>
                            <div className="trancarousel_item">
                              <p>
                                <Link to="/">
                                  Nhiều ngân hàng, nhà mạng di động lẫn cơ quan
                                  công an tiếp tục lên tiếng cảnh báo chiêu trò
                            ...
                            <div className="trancarousel_item">
                              <p>
                                <Link to="/">
                                  Một chiêu trò lừa đảo qua mạng "biến tướng"
                                  khác khá phổ biến thời gian gần đây là chuyển
